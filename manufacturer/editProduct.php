...
$product = getProductByIdWithManufacturerId($id, $manufacturerId);
extract($product);
...
if (isset($_POST["submit"])) {
  ...
  if (updateProduct($id, $productName, $price, $quantity, $visibility, $imageURL, $categoryId, $description, $manufacturerId, $dt)) {
    $_SESSION["successes"][] = "Product has been updated.";
  } else {
    $_SESSION["errors"][] = "Product was not updated.";
  }
}
