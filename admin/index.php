...
<div class="container container-fluid">
  ...
  <div class="text-center">
    ...
    <div class="btn-group-lg" role="group">
      ...
      <a href="add_new_category.php"><button type="button" class="btn btn-info">Add New Category</button></a>
      <a href="manage_categories.php"><button type="button" class="btn btn-info">Manage Categories</button></a>
    </div>
  </div>
</div>
