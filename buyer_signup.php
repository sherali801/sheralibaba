  ...
  if (!$result) {
    ...
    if ($db->affected_rows == 1) {
      ...
      $sql = "INSERT INTO buyer (
              ...
              '{$first_name}', '{$last_name}', '{$contact_no}', '{$email}', '{$dt}', '{$dt}'
              )";
      $db->query($sql);
      if ($db->affected_rows == 1) {
...
<div class="container container-fluid">
  <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" class="form-horizontal">
    <h2 class="text-center">Buyer Sign Up</h2>
    <?php
    if ($messages) {
    ...
    <div class="form-group">
      ...
      <div class="col-sm-2">
        <input type="text" name="first_name" value="<?php echo htmlentities($first_name); ?>" class="form-control" placeholder="First" maxlength="25" required data-toggle="tooltip" data-placement="right">
      </div>
      <div class="col-sm-2">
